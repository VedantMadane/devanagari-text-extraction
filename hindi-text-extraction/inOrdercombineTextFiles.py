...
def combine_text_files_in_order(folder_path, output_file):
  ...
  page_pattern = r'^page(\d+)OfKhanda4.txt$'
...
# Example usage
folder_path = 'D:\Projects\hindi-text\output\khanda4\\'  # Replace with your folder path
output_file = 'D:\Projects\hindi-text\output\marathi_vol4.txt'
